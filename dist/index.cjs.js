...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", backgroundAlt: "#FFFFFF", cardBorder: "#E7E3EB", contrast: "#191326", dropdown: "#F6F6F6", dropdownDeep: "#EEEEEE", invertedContrast: "#FFFFFF", input: "#F5F1EB", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#464754", textDisabled: "#BDC2C4", textDimmed: "#A69F9F", textSubtle: "#7A6EAA", disabled: "#E9EAEB", gradients: {
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#9A6AFF", background: "#08060B", backgroundDisabled: "#3c3742", backgroundAlt: "#27262c", cardBorder: "#383241", contrast: "#FFFFFF", dropdown: "#1E1D20", dropdownDeep: "#100C18", invertedContrast: "#191326", input: "#372F47", inputSecondary: "#262130", primaryDark: "#0098A1", tertiary: "#353547", text: "#F4EEFF", textDisabled: "#666171", textDimmed: "#666171", textSubtle: "#B8ADD2", disabled: "#524B63", gradients: {
...
var PanelBody = function (_a) {
    ...
    return (React__default["default"].createElement(Container$1, null, links.map(function (entry) {
        ...
        var iconElement = React__default["default"].createElement(Icon, { width: "24px", mr: "20px" });
